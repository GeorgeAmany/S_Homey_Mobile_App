...
class SecurityCallHelpActivation extends StatefulWidget {
  ...
  @override
  State<SecurityCallHelpActivation> createState() =>
      _SecurityCallHelpActivationState();
}

class _SecurityCallHelpActivationState
    extends State<SecurityCallHelpActivation> {
  @override
  void initState() {
  ...
  Future<void> _getInfo() async {
    ...
    final url = Uri.parse(
        'https://shomey-test-default-rtdb.firebaseio.com/callHelp.json?orderBy="userID"&equalTo="' +
            userId +
            '"');
